...
gp.c("plot 'mfsam.txt' using ($0):4:xtic(1) with boxes title 'TM-FSA' lc rgb '#FF1493', \
	''using ($0+0.1):3 with boxes title 'MTM-FSA' lc rgb '#6A5ACD'")
#, \
